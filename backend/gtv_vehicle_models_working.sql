-- Working GTV Motor Vehicle Models Setup
-- This script creates vehicle models and handles table structure differences
...
-- Step 8: Show final vehicle models overview
SELECT
...
-- Step 10: Show current vehicles (if any)
SELECT
